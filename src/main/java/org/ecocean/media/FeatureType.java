...
public class FeatureType implements java.io.Serializable {
    ...
    public static FeatureType load(final String id, Shepherd myShepherd) {
        return (FeatureType)(myShepherd.getPM().getObjectById(myShepherd.getPM()
                    .newObjectIdInstance(FeatureType.class, id), true));
    }
    public static ArrayList<FeatureType> getAll() {
        if (allTypes == null)
            throw new RuntimeException(
                      "FeatureType.initAll() has not been called");
        return allTypes;
    }
