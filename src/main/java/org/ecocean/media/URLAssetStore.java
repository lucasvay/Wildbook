...
public class URLAssetStore extends AssetStore {
    ...
    URLAssetStore(final Integer id, final String name, final AssetStoreConfig
    ...
    @Override public boolean cacheLocal(MediaAsset ma, boolean force) {
        ...
        try {
            ...
            System.out.println("WARN: cacheLocal got " + ioe.toString() +
                " while fetching " + url + " via " + ma.toString());
            return false;
        }
        return true;
    }
