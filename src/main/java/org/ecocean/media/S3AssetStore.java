...
public class S3AssetStore extends AssetStore {
    private static final Logger logger = LoggerFactory.getLogger(org.ecocean.
            media.S3AssetStore.class);
     ...
     * root.
     */
    public S3AssetStore(final String name, final AssetStoreConfig cfg, final
        boolean writable) {
     ...
     */
    S3AssetStore(final Integer id, final String name, final AssetStoreConfig
        config, final boolean writable) {
    ...
    public AmazonS3 getS3Client() {
        ...
        if ((config.getString("AWSAccessKeyId") != null) && (config.getString(
            "AWSSecretAccessKey") != null))
            s3Client = new AmazonS3Client(new BasicAWSCredentials(config.
                    getString("AWSAccessKeyId"), config.getString(
                "AWSSecretAccessKey")));
    ...
    public S3Object getS3Object(MediaAsset ma) {
        ...
        S3Object s3object = getS3Client().getObject(new GetObjectRequest(bp.
                toString(), kp.toString()));


        return s3object;
    }
    public MediaAsset copyIn(final File file, final JSONObject params, final
        boolean createMediaAsset)
    throws IOException {
        if (!this.writable)
        ...
        if (file.length() > 5 * 1024 * 1024 * 1024)
            throw new IOException(
                      "S3AssetStore does not yet support file upload > 5G");
        ...
        if ((bp == null) || (kp == null))
            throw new IllegalArgumentException(
                      "Invalid bucket and/or key value");
        getS3Client().putObject(new PutObjectRequest(bp.toString(), kp.toString
            (), file));
    ...
    throws IOException {
        ...
        if (!(fromMA.getStore() instanceof S3AssetStore) || !(toMA.getStore()
            instanceof S3AssetStore))
            throw new IOException("invalid AssetStore type(s)");
        if (!toMA.getStore().writable)
            throw new IOException(toMA.getStore().name +
                    " is a read-only AssetStore");
        ...
        if ((fromB == null) || (fromK == null))
            throw new IOException(
                      "Invalid bucket and/or key value for source MA " + fromMA)
                ;
        ...
        if ((toB == null) || (toK == null))
            throw new IOException(
                      "Invalid bucket and/or key value for target MA " + toMA);
        System.out.println("S3AssetStore.copyAsset(): " + fromB.toString() +
            "|" + fromK.toString() + " --> " + toB.toString() + "|" + toK.
                toString());
        // getS3Client() gets aws credentials from this instance S3AssetStore
        getS3Client().copyObject(new CopyObjectRequest(fromB.toString(), fromK.
                toString(), toB.toString(), toK.toString()));
    }
    @Override public void deleteFrom(final MediaAsset ma) {
        ...
        if ((bp == null) || (kp == null))
            throw new IllegalArgumentException(
                      "Invalid bucket and/or key value");
        getS3Client().deleteObject(new DeleteObjectRequest(bp.toString(), kp.
                toString()));
    }
/*
 ...
 */
        ...
        try {
            u = new URL("https://" + bp.toString() + ".s3.amazonaws.com/" + kp.
                    toString());
        } catch (Exception ex) {}
        return u;
    }
    ...
    @Override public String hashCode(JSONObject params) {
        ...
        return prefix + S3AssetStore.hexStringSHA256(bp.toString() + "/" + kp.
                    toString());
    }
    @Override public JSONObject createParameters(File file, String grouping) {
        ...
        if ((this.config == null) || (this.config.getString("bucket") == null))
            throw new IllegalArgumentException(this +
                    " does not have a default bucket value");
        ...
        if (grouping == null)
            grouping = Util.hashDirectories(Util.generateUUID(), "/");
    ...
    throws IOException {
        if (ma == null)
            throw new IOException(
                      "S3AssetStore.convertToLocal() passed null MediaAsset");
        if ((ma.getStore() == null) || !(ma.getStore() instanceof S3AssetStore))
            throw new IOException(
                      "S3AssetStore.convertToLocal() passed MediaAsset is not S3 type");
        ...
        if (lpath == null)
            throw new IOException(
                      "S3AssetStore.convertToLocal() could not get localPath for "
                      + ma);
        ...
        try {
            ...
            throw new IOException(
                      "S3AssetStore.convertToLocal() cacheLocal() for " + ma +
                      " threw " + ex.toString());
        }
        if (!got || !Files.exists(lpath))
            throw new IOException(
                      "S3AssetStore.convertToLocal() could not retrieve S3 source to "
                      + lpath);
