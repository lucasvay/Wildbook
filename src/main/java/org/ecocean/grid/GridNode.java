...
public class GridNode {
    ...
    public GridNode(HttpServletRequest request, int startGroupSize) {
        ...
        if ((request.getParameter("newEncounterNumber") != null) && (!request.
                getParameter("newEncounterNumber").equals("")))
            targeted = true;
    }
    ...
    public int getNextGroupSize(long checkoutTimeout, int maxGroupSize, int
        defaultGroupSize) {
        /*
         * if (lastCheckout != 2) {
