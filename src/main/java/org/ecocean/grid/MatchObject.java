...
public class MatchObject implements java.io.Serializable {
    ...
    public MatchObject(String individualName, double matchValue, double
        adjustedMatchValue, int numTriangles, ArrayList scores, String
        encounterNumber, String pointBreakdown, double[] logMbreakdown, String
        catalogSex, String date, double size) {
    ...
    public MatchObject(String individualName, double matchValue, int
        numTriangles, String encounterNumber) {
        this.matchValue = matchValue;
        this.individualName = individualName;
        this.numTriangles = numTriangles;
        this.encounterNumber = encounterNumber;
    ...
    public String getLogMStdDev() {
        if (logMbreakdown == null) {
            ...
            for (int iter5 = 0; iter5 < logMSize; iter5++)
                stdDeviationLogM += Math.pow((logMbreakdown[iter5] - meanLogM),
                    2);
            ...
            try {
                stdDeviationLogM = Math.pow((stdDeviationLogM / (logMbreakdown.
                        length - 1)), 0.5);
