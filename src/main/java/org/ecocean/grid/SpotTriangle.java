...
// public spot s1, s2, s3;
    ...
    public SpotTriangle(Spot i, Spot j, Spot k, double epsilon) {
        this.Dij = Point2D.distance(i.getCentroidX(), i.getCentroidY(), j.
                getCentroidX(), j.getCentroidY());
        this.Dik = Point2D.distance(i.getCentroidX(), i.getCentroidY(), k.
                getCentroidX(), k.getCentroidY());
        this.Djk = Point2D.distance(j.getCentroidX(), j.getCentroidY(), k.
                getCentroidX(), k.getCentroidY());
        ...
        tC2 = 2 * S2 * epsilon * epsilon * VarFact + 3 * C * C * Math.pow(
            epsilon, 4) * VarFact * VarFact;
    ...
    public boolean containsSpot(Spot x) {
        if ((x.getCentroidX() == v1.getCentroidX()) && (x.getCentroidY() == v1.
                getCentroidY()))
            return true;
        else if ((x.getCentroidX() == v2.getCentroidX()) && (x.getCentroidY() ==
            v2.getCentroidY()))
            return true;
        else if ((x.getCentroidX() == v3.getCentroidX()) && (x.getCentroidY() ==
            v3.getCentroidY()))
            return true;
        return false;
    }
