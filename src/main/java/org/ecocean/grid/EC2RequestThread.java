    ...
    private void getEC2Instances() {
        try {
            ...
            AWSCredentials credentials = new PropertiesCredentials(new File(
                props.getProperty("credentialsFileFullPath")));
            ...
            com.amazonaws.services.ec2.model.Filter runningInstancesFilter = new
                com.amazonaws.services.ec2.model.Filter("instance-state-name",
                allowedInstanceValues);


            int maxInstances = (new Integer(props.getProperty("maxInstances"))).
                    intValue();
