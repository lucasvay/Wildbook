...
public class WorkAppletHeadlessEpic {
    ...
    public void getGoing(int numProcessors) {
        ...
        try {
            ...
            System.out.println("...I have " + numProcessors +
                " processor(s) to work with...");
            ...
            hb = new AppletHeartbeatThread(sNodeIdentifier, numProcessors,
                urlArray.get(i), version);
            ...
            while (repeat) {
                ...
                try {
                    ...
                    try {
                        ...
                        String encNumParam = "&newEncounterNumber=" +
                            holdEncNumber;


                        java.net.URL u = new java.net.URL(urlArray.get(i) +
                            "/scanAppletSupport?version=" + version +
                            "&nodeIdentifier=" + nodeID + "&action=" +
                            "getWorkItemGroup" + encNumParam + "&groupSize=" +
                        ...
                        try {
                            inputFromServlet = new ObjectInputStream(new
                                BufferedInputStream(new GZIPInputStream(con.
                                        getInputStream())));
                    ...
                    if (successfulConnect) {
                        ...
                        // kick it like Poison!
                            ...
                            ArrayBlockingQueue abq = new ArrayBlockingQueue(1000
                                ...
                                ThreadPoolExecutor threadHandler = new
                                ThreadPoolExecutor(numProcessors, numProcessors,
                                    0, TimeUnit.SECONDS, abq);


                                for (int q = 0; q < vectorSize; q++) {
                                ScanWorkItem tempSWI = (ScanWorkItem)workItems.
                                    get(q);


                                // we also pass in workItemResults, which is a threadsafe vector of the results returned from each thread
                                try {
                                    threadHandler.submit(new
                                    AppletWorkItemThread(tempSWI,
                                    workItemResults));
                                } catch (Exception e) {
                                    System.out.println(
                                ...
                                while (threadHandler.getCompletedTaskCount() <
                                vSize
                                ) {}
                                ...
                                URL finishScan = new URL(urlArray.get(i) +
                                    "/ScanWorkItemResultsHandler2?" +
                                    "group=true&nodeIdentifier=" + nodeID);


                                System.out.println(
                                "Trying to send results to: " + finishScan.
                                    toString());
                                ...
                                if (urlArray.get(i).substring(0, 5).equals(
                                "https"))
                                    finishConnection = (HttpsURLConnection)
                                    finishScan.openConnection();
                                else
                                    finishConnection = (HttpURLConnection)
                                    finishScan.openConnection();
                                ...
                                finishConnection.setRequestProperty(
                                ...
                                try {
                                    ...
                                    ObjectOutputStream(new
                                        ...
                                        GZIPOutputStream(finishConnection.
                                            getOutputStream())));

                                    // sendObject(outputToFinalServlet, workItemResults);
                                    System.out.println(
                                    "     : Sending returned results...");
                                    // new modification
                                    ...
                                    try {
                                        ...
                                        if (workItemResults != null)
                                            outputToFinalServlet.writeObject(
                                            workItemResults);
                                    ...
                                    inputStreamFromServlet = finishConnection.
                                        getInputStream();


                                    BufferedReader in = new BufferedReader(new
                                        InputStreamReader(inputStreamFromServlet
                                        ));
                                ...
                                if (line.equals("success")) {
                                    ...
                                    System.out.println(
                                    "Unsuccessful results transmit error!");
                                }
                            }
                        }
                    }
