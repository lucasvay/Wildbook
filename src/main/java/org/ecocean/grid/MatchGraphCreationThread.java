...
public class MatchGraphCreationThread implements Runnable, ISharkGridThread {
    ...
    public MatchGraphCreationThread(HttpServletRequest request) {
        ...
        threadCreationObject = new Thread(this, (
            "MatchGraphCreationThread.class"));
    ...
    public void createThem() {
        ...
        javax.jdo.FetchGroup grp2 = pmf.getFetchGroup(Encounter.class,
            "encSearchResults");
        grp2.addMember("sex").addMember("catalogNumber").addMember("year").
                addMember("hour").addMember("month").addMember("minutes").
                addMember("day").addMember("spots").addMember("rightSpots").
                addMember("leftReferenceSpots").addMember("rightReferenceSpots")
            ;
        ...
        System.out.println(
            "MatchGraphCreationThread is exploring this many encounters: " +
            numEncs);
        ...
        try {
            ...
            for (int i = 0; i < numEncs; i++) {
                ...
                if (((enc.getRightSpots() != null) && (enc.getRightSpots().size
                    () > 0)) || ((enc.getSpots() != null) && (enc.getSpots().
                        size() > 0))) {
