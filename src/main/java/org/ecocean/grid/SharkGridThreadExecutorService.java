        ...
        try {
            if (threadPool == null) {
                ...
                if (!gm.getCreationThread())
                    threadPool = new SharkGridThreadPoolExecutor(gm.
                            getCreationDeletionThreadQueueSize(), gm.
                            getCreationDeletionThreadQueueSize());
            ...
            jdo.printStackTrace();
            System.out.println(
                "I couldn't instantiate the sharkGridThreadExecutorService.");
            return null;
        }
    }
}
