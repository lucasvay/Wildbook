...
public class ScanTask implements Serializable {
     ...
     * </ul>
     */
    public ScanTask(Shepherd myShepherd, String uniqueNum, Properties props,
        String encounter2scan, boolean writeThis) {
    ...
    public ArrayList<String> getLocationIDFilters() {
        return locationIDFilters;
    }

    public void addLocationIDToFilter(String locID) {
        if (locationIDFilters == null)
            locationIDFilters = new ArrayList<String>();
